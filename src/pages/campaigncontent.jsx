...
const services = {
  ...
  "seasonalcrop": {
    ...
    points: [
      {
        title: "Seasonal Crop Selection",
        text: "Guidance on selecting crops that are suitable for the current season and local conditions."
      },
      {
        title: "Better Planning",
        text: "Helping farmers plan planting and harvesting activities at the right time."
      },
      {
        title: "Higher Productivity",
        text: "Encouraging farming practices that can improve crop growth and farm productivity."
      }
    ]
  },
    ...
    points: [
      {
        ...
        text: "Promoting irrigation methods that deliver water directly where crops need it."
      },
      {
        title: "Water Conservation",
        text: "Encouraging farmers to reduce water loss and conserve available resources."
      },
      {
        title: "Better Water Planning",
        text: "Helping farmers understand when and how much water their crops require."
      }
    ]
  },
    ...
    points: [
      {
        ...
        text: "Providing farmers with useful information related to crops, farming methods, and resources."
      },
      {
        title: "Problem Solving",
        text: "Helping farmers identify common farming challenges and find practical solutions."
      },
      {
        title: "Farmer Resources",
        text: "Connecting farmers with relevant agricultural resources and opportunities."
      }
    ]
  },
  ...
  "organicfarming": {
    ...
    points: [
      {
        title: "Healthy Soil",
        text: "Encouraging practices that help maintain and improve soil quality."
      },
      {
        title: "Natural Practices",
        text: "Promoting responsible and environmentally friendly farming techniques."
      },
      {
        title: "Sustainable Farming",
        text: "Supporting farming methods that can remain productive for future generations."
      }
    ]
  },
    ...
    points: [
      {
        ...
        text: "Teaching farming techniques that farmers can apply directly in their fields."
      },
      {
        title: "Modern Techniques",
        text: "Introducing farmers to useful modern agricultural practices and technologies."
      },
      {
        title: "Knowledge Sharing",
        text: "Creating opportunities for farmers to learn from experts and other farming communities."
      }
    ]
  },
    ...
    points: [
      {
        ...
        text: "Providing useful information about market opportunities and customer demand."
      },
      {
        title: "Better Connections",
        text: "Helping farmers connect with potential buyers and agricultural markets."
      },
      {
        title: "Better Selling Decisions",
        text: "Helping farmers understand market conditions so they can plan their sales more effectively."
      }
    ]
  },
    ...
    points: [
      {
        ...
        text: "Encouraging farming practices that help farmers adapt to changing weather conditions."
      },
      {
        title: "Resource Efficiency",
        text: "Promoting efficient use of water, soil, energy, and other agricultural resources."
      },
      {
        title: "Resilient Agriculture",
        text: "Supporting farming systems that are better prepared for environmental challenges."
      }
    ]
  }
